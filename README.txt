...
a persistence unit "ExamenSimbanaJonnathanClientePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenSimbanaJonnathanCliente\pom.xml":
...
artifact ("ExamenSimbanaJonnathanCliente.war") is already built. You can build
